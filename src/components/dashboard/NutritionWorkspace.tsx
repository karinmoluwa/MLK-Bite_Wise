  ...
  return (
    <div className="nutrition-app">
      ...
      {view === "dashboard" && <Dashboard
        ...
        reminders={reminders} dismissReminder={(id: number) => setReminders((items) => items.filter((item) => item.id !== id))}
      ...
      {view === "favourites" && <Favourites savedMeals={savedMeals} setSavedMeals={setSavedMeals} chooseCandidate={chooseCandidate} />}
    </div>
  );
}

...
export function AppShell({
  ...
  // Load the signed-in user's real username/profile
  useEffect(() => {
      ...
      {sessionNotice && (
        ...
        >
          ...
          >
            ...
            <p>
              For your security, Bite Wise signs you
              out after a period of inactivity. Your
              saved information remains secure.
            </p>

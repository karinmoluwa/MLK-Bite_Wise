...
export function AppShell({ children }: { children: React.ReactNode }) {
  ...
  // Load the currently signed-in Firebase user.
  useEffect(() => {
  ...
  // Sign the user out of Firebase and return to login.
  const signOut = async () => {
  ...
  const nav = (items: typeof primaryNavigation) =>
    items.map((item, index) => (
      <a
        className={`app-nav-link ${index === 0 ? "is-active" : ""}`}
        href={item.href}
        key={item.label}
  ...
  return (
    <div
      className={`application-frame ${
        tabletCollapsed ? "sidebar-collapsed" : ""
      }`}
    >
      ...
      >
        <div className="sidebar-brand">
          ...
          <span className="brand-copy">
            <strong>Bite Wise</strong>
            <small>Nutrition, made clearer</small>
          </span>
      ...
      <div className="app-content-column">
        <header className="app-topbar">
          <div className="topbar-leading">
            ...
            <button
              className="icon-button tablet-toggle"
              type="button"
          ...
          <div className="topbar-actions">
            <label className="global-search">
              ...
              <input
                type="search"
                placeholder="Search meals and insights"
              />
            </label>
      ...
      {sessionNotice && (
        ...
        >
          ...
          >
            ...
            <p>
              For your security, Bite Wise signs you out
              after a period of inactivity. Your saved
